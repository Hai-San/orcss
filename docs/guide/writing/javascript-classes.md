...
* São classes utilizadas para manipulação da DOM (loops, inserts, remove etc...)
  * Esse tipo de classe não é utilizado para manipulação de estilos. Para isso são utilizadas as [classes de estado](status-classes.md).
